            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ســهـۍ 𖠇𝗦𝗢𝗛𝗔𖠇--------"
                        ...
                        link = "[𐇮 𖠇الامبراطور 𖠇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_A_Q)"
                        text = (
                            "**✘ تقـريـر اشعـار ســهـۍ 𖠇𝗦𝗢𝗛𝗔𖠇 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ســهـۍ 𖠇𝗦𝗢𝗛𝗔𖠇 ✘**\n\n "
                        link = "[𐇮 𖠇الامبراطور 𖠇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_A_Q)"
