...
zel_dev = (925972505, 1895219306, 6218149232)
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐇𝐀 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/mcsec7) 𓆪\n\n"
...
async def permalink(malath):
    ...
    if user.id in zel_dev:
        return await edit_or_reply(malath, f"**╮ ❐ لك هـذا الامبراطور  الهيبـه . . شما حجيت ماكـدر اوصفـه 🙊💘 ❏╰**")
    tag = user.first_name.replace("\u2060", "") if user.first_name else user.username
