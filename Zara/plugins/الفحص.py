...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بوت ســهـۍ 𝗦𝗢𝗛𝗔 يعمـل  ..  بنجـاح☑️𓆩   **"
...
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/mcsec7)"""
...
async def amireallyialive(event):
    ...
    reply_to_id = await reply_id(event)
    Z_EMOJI = gvarstatus("ALIVE_EMOJI") or "✥┊"
    zed_caption = "** بوت ســهـۍ 𝗦𝗢𝗛𝗔 يعمـل  ..  بنجـاح☑️𓆩   **\n"
