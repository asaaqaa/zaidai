...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/mcsec7) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر البـــوت 🦾🤖](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
...
**- الوصـف :**
لـ عـرض تاريـخ بـدء تنصيبك على سـورس ســهــۍ
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ســهــۍ
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر المجمــوعــه 🛗](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/mcsec7) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر مكـافح التكــرار 🛡](t.me/mcsec7) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر المنــع 🚫](t.me/mcsec7) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الاضـافه والتفليـش 👾](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الفــارات 🧬](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر فــارات الوقتــي 🕰](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر فــارات حمايـة الخــاص 🛄](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر فــارات الفحـص 🏮](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس ســهــۍ بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر التسليـه والتحشيش 🏂🎃](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر التسليـه 🏂](t.me/mcsec7) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر التحشيش 🎃](t.me/mcsec7) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الالـعــاب 🎮🎳](t.me/mcsec7) .
**- الامـر :**
**⪼** `.بلاي`
**العــاب الانـلايـن لســورس ســهــۍ 🕹**
**⪼** `.كت`
**اسئلـة كـت تـويت ⁉️**
**⪼** `.كت`
...
**- الوصـف :**
العـاب سـورس ســهــۍ ممطـروقـه 🥳💞
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر حمـايــة الخــاص 🛡](t.me/mcsec7) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - فــارات حمـايــة الخــاص 🛡](t.me/mcsec7) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر المـرفقــات 🖥](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الستـوريـات 🎆🏖](t.me/mcsec7) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/mcsec7) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الادوات 💡](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - ادوات الروابــط 💡](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الاشتــراك الاجبــاري 🛗](t.me/mcsec7) .
**- الامـر :**
...
**- ملاحظـه :**
سـورس ســهــۍ هو اول من كتب فكرة الاشتراك الاجباري واضافها للسورس كـ فكرة جديدة لسورسات تيليثون
الملف كان مدفوع وتم تنزيله مجاني
تـاريـخ كتابـة الملـف - 30 اكتوبر/2022 
 https://t.me/mcsec7/260
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر الصيـد & التشيكـر ❇️](t.me/mcsec7) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر تجميـع النقـاط 💡](t.me/mcsec7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر تجميــع النقــاط 🛂](t.me/mcsec7) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝑆𝑂𝐔𝑅𝐶𝐸 𝑆𝞝𝑂𝐻𝐴ُٓ   - اوامــر النشــر التلقــائي 🌐](t.me/mcsec7  ) .
**- الامـر :**
**⪼** `.تلقائي`
