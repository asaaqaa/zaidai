...
ZelzalDV_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐇𝐀 - اوامــر المطـور المســاعد](t.me/mcsec7) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 𝗔𝗟𝞝𝗘𝗠𝗣𝗘𝗥𝗧𝗢𝗥  الهہـيـبه 𐇮](t.me/A_S_A_A_Q) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت سـهــۍ انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝐒𝐎𝐇𝐀 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت سـهــۍ انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
