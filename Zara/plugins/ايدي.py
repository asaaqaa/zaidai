...
# الـرتب الوهميـه & فارات الكليشـه & البريميـوم & عـدد الرسـائل & التفاعـل = كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l / خاصـه بسـورس - ســهـۍ @ZThon فقـط
...
################# Dev ZilZal #################
    if user_id in zelzal: #Code by T.me/zzzzl1l
        ...
        rotbat = "⌁ العضـو 𓅫 ⌁"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ســهـۍ"  #Code by T.me/zzzzl1l
